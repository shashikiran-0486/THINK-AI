...
import { u as useNavigate, L as Link, t as toast, s as supabase } from "./router-Ch4Sxf0h.js";
...
function LoginPage() {
  ...
  const submit = async (e) => {
    ...
    const {
      error
    } = await supabase.auth.signInWithPassword(r.data);
    setLoading(false);
    if (error) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-md px-3 py-12 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl", children: "LOG IN" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "mt-6 space-y-4 border-2 border-ink bg-card p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: loading, className: "btn-chunk w-full bg-neon py-3 text-sm font-bold uppercase disabled:opacity-50", children: loading ? "…" : "Log In" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs", children: [
        "New here? ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", className: "font-bold underline", children: "Sign up" })
      ] })
    ] })
  ] });
}
