...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-phj3UPoU.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ccWGIwOv.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "THINK-AI";
var SERVER_FN_BASE = "/THINK-AI/_serverFn/";
