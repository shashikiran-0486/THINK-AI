...
import { c as createLucideIcon, s as supabase, L as Link, S as Sparkles } from "./router-ccWGIwOv.js";
...
const heroImg = "/THINK-AI/assets/hero-OEJP4MI1.jpg";
function HomePage() {
  const [trending, setTrending] = reactExports.useState([]);
  reactExports.useEffect(() => {
    supabase.from("products").select("*").eq("trending", true).limit(6).then(({
      data
    }) => setTrending(data ?? []));
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative overflow-hidden border-b-2 border-ink bg-ink text-bone", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-6 px-3 py-10 sm:px-6 sm:py-16 md:grid-cols-2 md:items-center md:gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sticker mb-3", children: "Drop 04 — Live" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.h1, { initial: {
          ...
          duration: 0.6
        }, className: "text-5xl leading-none sm:text-6xl md:text-7xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "WEAR" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-neon", children: "YOUR" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block", children: "VOLUME." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-md text-sm text-bone/70 sm:text-base", children: "Streetwear built for the after-hours. Loud prints, heavyweight fabric, and a 24/7 AI style concierge that actually gets it." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/shop", className: "btn-chunk inline-flex items-center gap-2 bg-neon px-5 py-3 text-sm font-bold uppercase text-ink", children: [
            "Shop the Drop ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "btn-chunk inline-flex items-center gap-2 bg-bone px-5 py-3 text-sm font-bold uppercase text-ink", children: "Our Story" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        duration: 0.6,
        delay: 0.1
      }, className: "relative aspect-[4/5] overflow-hidden border-2 border-bone", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: "ThinkBold drop 04 hero", className: "h-full w-full object-cover", width: 1536, height: 1024 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticker absolute right-2 top-2", children: "🔥 Hot" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-3 py-10 sm:px-6 sm:py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-5 text-3xl sm:text-4xl", children: "Shop By Vibe" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-3", children: [{
        ...
        to: "/women",
        label: "Women",
        color: "bg-magenta text-bone"
      }, {
        to: "/accessories",
        label: "Accessories",
        color: "bg-ink text-bone"
      }].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: c.to, className: `group relative flex h-40 items-end overflow-hidden border-2 border-ink p-4 ${c.color} transition hover:scale-[1.02]`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl uppercase", children: c.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "absolute right-4 top-4 h-5 w-5 transition group-hover:translate-x-1" })
      ] }, c.to)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-7xl px-3 pb-10 sm:px-6 sm:pb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 flex items-end justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl", children: "🔥 Trending" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "text-xs font-bold uppercase underline underline-offset-4", children: "View all" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4", children: trending.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p }, p.id)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y-2 border-ink bg-magenta text-bone", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl flex-col items-start gap-4 px-3 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full border-2 border-bone bg-ink p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-6 w-6 text-neon" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl sm:text-3xl", children: "MEET THINKAI." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 max-w-md text-sm text-bone/90", children: "Your 24/7 AI style concierge. Ask for outfit ideas, sizing help, or order info — instant answers, zero hold music." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
        document.querySelector('button[aria-label="Open ThinkAi chat"]')?.click();
      }, className: "btn-chunk inline-flex items-center gap-2 bg-neon px-5 py-3 text-sm font-bold uppercase text-ink", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-4 w-4" }),
        " Chat with ThinkAi"
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-3xl px-3 py-14 text-center sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl", children: "BUILT LOUD. WORN LOUDER." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground sm:text-base", children: "ThinkBold is for the kids who don't fade into the background. Every drop is small, intentional, and engineered to last past the trend cycle." })
    ] })
  ] });
}
export {
